...
{
    [Deck("Expert_2026_BrElfnote", "2026_BrElfnote")]
    public class ExpertBrElfnoteExecutor : _2026_BrElfnoteExecutor
    {
        private string _duelId;

        public ExpertBrElfnoteExecutor(GameAI ai, Duel duel)
            : base(ai, duel)
        {
